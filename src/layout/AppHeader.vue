    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon text-info">
                        <!-- <base-button type="secondary">Job application </base-button> -->
                        <base-button tag="a" size="lg" class="active" role="button" aria-pressed="true" @click="scrollToRegisterForm">Join us</base-button>
                    </a>
                </li>
                <li class="nav-item">
